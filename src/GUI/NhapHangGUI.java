...
public class NhapHangGUI extends JPanel implements MouseListener{
    ...
    private ArrayList<ChiTietPNHDTO> dsctpnh = new ArrayList<>(); //Tạo Arraylist để lưu tạm CHTD trên table
    ...
    {    
        ...
        //----------------------Panel Hóa đơn-------------------------//
            ...
            lbTraNCC = new JLabel("Cần trả NCC");
            ...
            scrollPane.setBorder(BorderFactory.createLineBorder(Color.BLACK));
             ...
             pThanhtoan = new JPanel(null);
                    ...
                    pThanhtoan.addMouseListener(this);
                        JLabel lbThanhtoan = new JLabel("Xác nhận",JLabel.CENTER);    
        ...
        pMenu_CTHD.setBackground(Color.WHITE);
                ...
                lbTienCTHD = new JLabel("Tổng tiền CTPNH");
...
//                
                ...
                btnSuaCTHD = new JButton("Sửa CTPNH");
                ...
                btnLuuCTHD = new JButton("Lưu CTPNH");
                ...
                btnThemCTHD = new JButton("Thêm CTPNH");
                ...
                btnXoaCTHD = new JButton("Xóa CTPNH");
           ...
           //-------------------------EVENT JPANEL HÓA ĐƠN------------------//
                ...
                //Thanh toán
                 ...
                 pThanhtoan.addMouseListener(new MouseAdapter() {
                    ...
                    int tongtienpnh = Integer.parseInt(txtTongtien.getText().replaceAll(",","")); //Xoa "," ra khỏi chuỗi
                    String pttt= cbbPTTT.getSelectedItem().toString();
                    String thoigian = lbDate.getText();
                    String ghichu = txtGhichu.getText();
                    
                    if(tennv.equals("---Chọn---") || tenncc.equals("") || tongtienpnh == 0 || pttt.equals("---Chọn---"))
                    {
                    ...
                    else
                    {
                        ...
                        dsctpnh.clear();
                        JOptionPane.showMessageDialog(null,"Nhập hàng hoàn tất !!!");
    ...
    public void outModel(DefaultTableModel model , ArrayList<ChiTietPNHDTO> dsctpnh) // Xuất ra Table từ ArrayList
    { 
       Vector data;
       model.setRowCount(0);
